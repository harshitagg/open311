...
class TestAccessService(unittest.TestCase):
    ...
    def test_post_sevice_requests(self):
        ...
        form_data = {'service_code' : 0,'lat' : 0.1,'long' : 0.1,'address_string' : 'address_string','address_id' : 1,'email' : 'email','first_name' : 'first_name','last_name' : 'last_name','phone' : 1234567890,'description' : 'description','device_id' : 'device_id',
            'account_id' : 'account_id','description' : 'description','media_url' : 'media_url'}
