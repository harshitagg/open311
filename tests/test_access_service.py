...
class TestAccessService(unittest.TestCase):
    ...
    def testGetServiceList(self):
        self.access_service_obj.add_service(0, "name", "description", True, "service type", ["keyword1","keyword2"], "group")
        self.assertEquals([{"service_code":"0", "service_name":"name", "description":"description", "metadata":"True", 
    ...
    def test_get_service_definition(self):
        ...
        self.access_service_obj.add_service_value(0, 1, "name", "code")
        self.access_service_obj.add_service_attribute(True, "code", "datatype", True, "datatype_description", 1, "description", 0)
        self.assertEquals({"service_code":"0", "attributes":{ "attribute":{ "variable":"True", "code":"code", "datatype":"datatype",
                                                                            "required":"True", 
    ...
    def test_add_requests(self):
        ...
        self.assertEquals(self.c.fetchone(), (0.1, 0.1, "address_string", 1, "email", "device_id", "account_id", "first_name", 
    ...
    def test_get_service_requests(self):
        ...
        self.access_service_obj.add_requests(lat = 0.1, long = 0.1, address_string =  "address_string", address_id  = 1, 
                                             ...
                                             updated_datetime = date)
        self.access_service_obj.add_requests_id(1)
        self.assertEquals([{'status' : 'open', 'status_notes' : 'status_notes', 'service_name' : 'name', 'service_code' : '0', 
