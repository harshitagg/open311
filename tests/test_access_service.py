...
class TestAccessService(unittest.TestCase):
    ...
    def testAddService(self):
        self.access_service_obj.add_service(0, "name", "description", True, "service type", ["keyword1", "keyword2"],
            "group")
    ...
    def testGetServiceList(self):
        self.access_service_obj.add_service(0, "name", "description", True, "service type", ["keyword1", "keyword2"],
            "group")
        self.assertEquals(
            [{"service_code": "0", "service_name": "name", "description": "description", "metadata": "True",
              "type": "service type", "keywords": "keyword1,keyword2", "group": "group"}],
            self.access_service_obj.getServiceList())

    def test_add_service_attribute(self):
        self.access_service_obj.add_service(0, "name", "description", True, "service type", ["keyword1", "keyword2"],
            "group")
        self.access_service_obj.add_service_attribute(True, "code", "datatype", True, "datatype_description", 1,
            "description", 0)
        self.c.execute("select * from attribute where service_code=0")
        self.assertEquals(self.c.fetchone(),
            (1, 1, "code", "datatype", 1, "datatype_description", 1, "description", 0));
    ...
    def test_get_service_definition(self):
        ...
        self.access_service_obj.add_service_attribute(True, "code", "datatype", True, "datatype_description", 1,
            "description", 0)
        self.assertEquals({"service_code": "0",
                           "attributes": {"attribute": {"variable": "True", "code": "code", "datatype": "datatype",
                                                        "required": "True",
                                                        "datatype_description": "datatype_description",
                                                        "order": "1", "description": "description",
                                                        "values": [{"value": {"key": "1", "name": "name"}}]}}},
            self.access_service_obj.getServiceDefinition(0))
    ...
    def test_add_requests(self):
        ...
        self.c.execute(
            "select lat, long, address_string, address_id, email, device_id, account_id, first_name, last_name, phone, description, media_url, service_code, status, status_notes, agency_responsible, service_notice, zipcode, expected_datetime , requested_datetime, updated_datetime from requests where id=1")
        self.assertEquals(self.c.fetchone(),
            (0.1, 0.1, "address_string", 1, "email", "device_id", "account_id", "first_name",
             "last_name", 1234567890, "description", "media_url", 0, "open", "status_notes",
             "agency_responsible", "service_notice", 111111, str(date), str(date), str(date)))
    ...
    def test_add_requests_token(self):
        ...
        self.access_service_obj.add_requests(lat=0.1, long=0.1, address_string="address_string", address_id=1,
            ...
            service_notice="service_notice", zipcode=111111, expected_datetime=date,
            requested_datetime=date, updated_datetime=date)
    ...
    def test_post_sevice_requests(self):
        ...
        form_data = {'service_code': 0, 'lat': 0.1, 'long': 0.1, 'address_string': 'address_string', 'address_id': 1,
                     'email': 'email', 'first_name': 'first_name', 'last_name': 'last_name', 'phone': 1234567890,
                     'description': 'description', 'device_id': 'device_id', 'account_id': 'account_id',
    ...
    def test_get_service_requests(self):
        ...
        self.access_service_obj.add_requests_id(1)
        self.assertEquals(
            [{'status': 'open', 'status_notes': 'status_notes', 'service_name': 'name', 'service_code': '0',
              'description': 'description', 'agency_responsible': 'agency_responsible',
              'service_notice': 'service_notice', 'requested_datetime': str(date), 'updated_datetime': str(date),
              'expected_datetime': str(date), 'address': 'address_string', 'address_id': '1',
              'zipcode': '111111', 'lat': '0.1', 'long': '0.1', 'media_url': 'media_url'}],
            self.access_service_obj.getServiceRequests(None))
    ...
    def test_get_service_request(self):
        ...
        self.assertEquals(
                {'status': 'open', 'status_notes': 'status_notes', 'service_name': 'name', 'service_code': '0',
                 'description': 'description', 'agency_responsible': 'agency_responsible',
                 'service_notice': 'service_notice', 'requested_datetime': str(date),
                 'updated_datetime': str(date), 'expected_datetime': str(date), 'address': 'address_string',
                 'address_id': '1', 'zipcode': '111111', 'lat': '0.1', 'long': '0.1', 'media_url': 'media_url'},
            self.access_service_obj.getServiceRequest(1))

    def test_get_request_id_from_token(self):
        self.access_service_obj.add_service(0, "name", "description", False, "", ["keyword1", "keyword2"], "group")
        date = datetime.utcnow()
        self.access_service_obj.add_requests(lat=0.1, long=0.1, address_string="address_string", address_id=1,
            email="email", device_id="device_id", account_id="account_id",
            ...
            updated_datetime=date)
        self.access_service_obj.add_requests_token(1)
        self.assertEquals({'service_request_id': '1', 'token': '1'},
            self.access_service_obj.getRequestIdFromToken(1))
